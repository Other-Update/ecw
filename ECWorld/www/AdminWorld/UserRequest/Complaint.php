        ...
        <div class="col-xs-12">
          <div class="box" style="border-top: none; ">
			...
			<div class="table-responsive">
              <table id="idTblComplaintData" class="table table-bordered table-striped"  style="width:100%;">
                <thead>
                <tr>
                  <th><?php echo $lang['date_time']; ?></th>
                  <th><?php echo $lang['recharge_by']; ?></th>
                  <th><?php echo $lang['request_id']; ?></th>
				  <th><?php echo $lang['transx_id']; ?></th>
