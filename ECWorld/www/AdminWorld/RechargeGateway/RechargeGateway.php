        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="DeSelectedTap" id="GeneralTab"><a href="#tab_3" data-toggle="tab"><h5><?php echo $lang['api_gateway_title']; ?></h5></a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
					<?php include 'RCGatewayUser.php'; ?>
              </div>
              <div class="tab-pane" id="tab_2">
					<?php include 'RCGatewayGeneral.php'; ?>
              </div>
              <div class="tab-pane" id="tab_3">
					<?php include 'RCGatewayAPI.php'; ?>
              </div>
            </div>
          </div>
        </div>
