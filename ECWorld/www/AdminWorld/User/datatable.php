...
include_once APPROOT_URL.'/Database/d_mysqldb.php';
/*
...
class TableData {
	...
	public function __construct() {
		try {
			...
			$user	= 'root';
			$passwd	= ''; 
			/* $database	= 'worldec_ecworld';
			$user	= 'worldec_ecworld';
			$passwd	= 'flNmEzEZa5WK'; */
	...
	public function get($table, $index_column, $columns) {
		...
		*/
		...
		$sQuery = "SELECT SQL_CALC_FOUND_ROWS u.DisplayID as UserID, u.Name, r.Name as RoleName, u.Mobile, u.Refundable, u.ParentID, u.ClientLimit, u.DOB, u.Active as Status FROM m_users as u left join m_role as r on u.RoleID=r.RoleID ORDER BY u.UserID ASC";
		//echo $sQuery;
		...
		// Output
		$output = array(
		"sEcho" => $this->sEcho_Custom,//intval($_GET['sEcho']),
...
// Get the data
$table_data->get('m_users', 'UserID', array('UserID','Name','RoleName','Mobile','Refundable','ParentID','ClientLimit','DOB','Status'));
/*
