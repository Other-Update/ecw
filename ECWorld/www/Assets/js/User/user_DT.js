	...
	dt=ecwDTAdv.init(
		...
		},
		{
			...
			"Columns":[
				...
				{"mData" : null,'sTitle':'Dep.Type','mRender':function(data){
					if(data[4]==1) { DepType = "Refundable"; } else if(data[4]==2) { DepType = "Non-Refundable"; } else{
						DepType = "N/A";
					}
					return DepType;
				}},
				...
				{"mData" : null,'sTitle':'DOB','bVisible':false,'mRender':function(data){
					return data[7];
				}},
