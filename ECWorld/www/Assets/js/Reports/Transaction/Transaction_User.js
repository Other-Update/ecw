...
function  getOpenCloseBalance() {
	...
	ajaxRequest ({
		...
		success: function(data){
			...
			$('#idTblTransaction tbody').prepend('<tr><td colspan="7" class="text-right">Opening Balance</td><td colspan="8">'+opening_bal+'</tr>');
			$('#idTblTransaction tbody').append('<tr><td colspan="7" class="text-right">Closing Balance</td><td colspan="8">'+closing_bal+'</tr>');
